          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6 mb-8">
              <div className="flex items-start">
                <FiAlertTriangle className="w-6 h-6 text-red-600 dark:text-red-400 mt-1 mr-3 flex-shrink-0" />
                <div>
                  <h2 className="text-xl font-bold text-red-800 dark:text-red-300 mb-2">Risk Warning</h2>
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">2. No Financial Advice</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">3. Affiliate Relationships</h2>
              
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-6">
                <div className="flex items-start">
                  <FiInfo className="w-6 h-6 text-blue-600 dark:text-blue-400 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="text-lg font-bold text-blue-800 dark:text-blue-300 mb-2">Affiliate Disclosure</h3>
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">4. Third-Party Platforms and Services</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">4.1 Forex and Trading Platforms</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">4.2 Cryptocurrency Platforms</h3>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">4.3 Betting and Gambling Platforms</h3>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">5. Accuracy of Information</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">6. Regulatory Compliance</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">7. Personal Responsibility</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">9. Updates and Changes</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              {/* Contact Section */}
              <div className="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-6 mt-8">
                <div className="flex items-start">
                  <FiShield className="w-6 h-6 text-gray-600 dark:text-gray-400 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Questions or Concerns?</h2>
                    <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6 mt-8">
                <div className="flex items-start">
                  <FiAlertTriangle className="w-6 h-6 text-yellow-600 dark:text-yellow-400 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="text-lg font-bold text-yellow-800 dark:text-yellow-300 mb-2">Remember</h3>
